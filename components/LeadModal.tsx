  ...
  if (type === 'limit') {
    return (
      <div className="fixed inset-0 z-[150] flex items-center justify-center p-4">
        ...
        <div className="relative w-full max-w-lg bg-zinc-900 rounded-3xl p-10 border-2 border-orange-500/30 shadow-[0_0_50px_rgba(249,115,22,0.1)]">
           <div className="text-center space-y-6">
              ...
              <div className="grid grid-cols-1 gap-4 pt-4">
                <a 
                  href="tel:1234567890"
                  className="w-full py-4 bg-orange-500 hover:bg-orange-400 text-white font-black rounded-2xl flex items-center justify-center gap-3 transition-all"
                >
    ...
    <div className="fixed inset-0 z-[150] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-zinc-900 rounded-3xl overflow-hidden border border-zinc-800 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-5">
          <div className="space-y-4">
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-zinc-800 border border-zinc-700 rounded-xl py-3.5 pl-12 pr-4 text-white focus:ring-2 focus:ring-orange-500 outline-none transition-all"
              />
            </div>
            <div className="relative">
          ...
          <button 
            type="submit"
            className="w-full py-4 bg-white text-zinc-950 font-black rounded-xl hover:bg-orange-500 hover:text-white transition-all transform active:scale-95"
          >
            CONTINUE CREATING
          </button>
